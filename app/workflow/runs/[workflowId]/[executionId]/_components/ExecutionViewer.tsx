...
import { DatesToDurationString } from "@/lib/helper/DateToDurationString";
...
export default function ExecutionViewer({
  ...
  useEffect(() => {
    ...
    // Auto select the last completed phase when it is not running
    const phaseToSelect = phases.toSorted((a, b) =>
...
function ParamaterViewer({
  ...
  return (
    <Card>
      <CardHeader className="rounded-1g rounded-b-none border-b py-4 bg-gray-50 dark:bg-background ">
